...
public sealed class NPCMind
{
    ...
    // §107: кого группа пошла бить. Стоит у КАЖДОЙ участницы сговора — общей
    ...
    // мера «побили»: с пощадой §107 он не падает, и без счётчика у расправы не
...
public enum GoalType
{
    ...
    // §107: идти бить чужака ВМЕСТЕ. Единственная цель, которую NPC берёт не
