...
public sealed class NPCMind
{
    ...
    // §121.7 (v46): последний момент внимания игрока — принятая команда или
    // завершение приказа. Ручная с целью None, у которой это окно старше
    // Spec121.ManualIdleReleaseTicks, автоматически возвращается под ИИ.
