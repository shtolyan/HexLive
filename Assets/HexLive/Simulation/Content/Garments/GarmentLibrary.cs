    ...
    public static class GarmentLibrary
    {
        ...
        private static List<GarmentParams> BuildDefaults()
        {
            ...
            return new List<GarmentParams>
            {
                ...
                new("underwear.bikini_top_mat06", "Bikini Top (Mat06)", WearLayer.Underwear, 0.01f, 0.00f, 0.00f, dress, 0, BodyPart.Torso) { PrototypeId = "underwear.bikini_top" },
                ...
                new("underwear.bikini_briefs_mat06", "Bikini Briefs (Mat06)", WearLayer.Underwear, 0.01f, 0.00f, 0.00f, dress, 0, BodyPart.Torso, BodyPart.Pelvis) { PrototypeId = "underwear.bikini_briefs" },
                ...
                new("clothing.shorts_vamp_blk_lea___lace", "Laced Shorts (Blk Lea + Lace)", WearLayer.Wear, 0.05f, 0.03f, 0.00f, dress, 1, BodyPart.Pelvis) { PrototypeId = "clothing.shorts_vamp" },
