    ...
    public static class GarmentLibrary
    {
        ...
        private static List<GarmentParams> BuildDefaults()
        {
            ...
            return new List<GarmentParams>
            {
                ...
                new("clothing.socks_nerd", "Knee Socks", WearLayer.Underwear, 0.05f, 0.00f, 0.00f, dress, 0, BodyPart.LegL, BodyPart.LegR),
                new("underwear.bra_crux", "Wild Bra", WearLayer.Underwear, 0.02f, 0.00f, 0.00f, dress, 0, BodyPart.Torso),
                new("underwear.panty_crux", "Wild Panties", WearLayer.Underwear, 0.02f, 0.00f, 0.00f, dress, 0, BodyPart.Pelvis),
                new("clothing.stockings_spooky", "Spooky Stockings", WearLayer.Underwear, 0.04f, 0.00f, 0.00f, dress, 0, BodyPart.LegL, BodyPart.LegR),
                new("underwear.babydoll_sweety", "Babydoll", WearLayer.Underwear, 0.04f, 0.00f, 0.00f, dress, 0, BodyPart.Torso, BodyPart.Pelvis),
                new("underwear.panty_sweety", "Sweety Panties", WearLayer.Underwear, 0.02f, 0.00f, 0.00f, dress, 0, BodyPart.Torso, BodyPart.Pelvis),
                ...
                new("clothing.outfit_reiko", "Wrestler Outfit", WearLayer.Wear, 0.22f, 0.06f, 0.00f, dress, 2, BodyPart.Torso, BodyPart.Pelvis, BodyPart.LegL, BodyPart.LegR),
                new("clothing.gloves_classic", "Classic Gloves", WearLayer.Wear, 0.05f, 0.03f, 0.00f, dress, 0, BodyPart.ArmL, BodyPart.ArmR),
                new("clothing.shorts_classic", "Classic Shorts", WearLayer.Wear, 0.07f, 0.00f, 0.00f, dress, 2, BodyPart.Pelvis),
                new("clothing.top_classic", "Classic Top", WearLayer.Wear, 0.06f, 0.00f, 0.00f, dress, 0, BodyPart.Torso),
                new("clothing.glasses_nerd", "Glasses", WearLayer.Wear, 0.00f, 0.00f, 0.00f, dress, 0, BodyPart.Head),
                ...
                new("clothing.suspenders_nerd", "Suspenders", WearLayer.Wear, 0.01f, 0.00f, 0.00f, dress, 0, BodyPart.Torso),
                new("clothing.skirt_tutu", "Tutu Skirt", WearLayer.Wear, 0.06f, 0.00f, 0.00f, dress, 0, BodyPart.Torso, BodyPart.Pelvis, BodyPart.LegL, BodyPart.LegR),
                new("clothing.cap_stars", "Uniform Cap", WearLayer.Wear, 0.05f, 0.02f, 0.00f, dress, 0, BodyPart.Head),
                new("clothing.gloves_stars", "Uniform Gloves", WearLayer.Wear, 0.04f, 0.02f, 0.00f, dress, 0, BodyPart.ArmL, BodyPart.ArmR),
                new("clothing.pants_stars", "Uniform Trousers", WearLayer.Wear, 0.17f, 0.02f, 0.00f, dress, 2, BodyPart.Pelvis, BodyPart.LegL, BodyPart.LegR),
                new("clothing.top_stars", "Uniform Top", WearLayer.Wear, 0.09f, 0.02f, 0.00f, dress, 0, BodyPart.Torso, BodyPart.ArmL, BodyPart.ArmR),
                new("clothing.skirt_crux", "Wild Skirt", WearLayer.Wear, 0.05f, 0.00f, 0.00f, dress, 0, BodyPart.Pelvis),
                ...
                new("clothing.boots_classic", "Classic Boots", WearLayer.Outerwear, 0.14f, 0.12f, 0.00f, dress, 0, BodyPart.LegL, BodyPart.LegR),
                new("clothing.scarf_classic", "Scarf", WearLayer.Outerwear, 0.09f, 0.00f, 0.02f, dress, 0, BodyPart.Torso),
                new("clothing.slipons_fads", "Slip-Ons", WearLayer.Outerwear, 0.06f, 0.02f, 0.00f, dress, 0, BodyPart.LegL, BodyPart.LegR),
                new("clothing.sneakers_nerd", "Sneakers", WearLayer.Outerwear, 0.07f, 0.02f, 0.00f, dress, 0, BodyPart.LegL, BodyPart.LegR),
                new("clothing.belt_stars", "Uniform Belt", WearLayer.Outerwear, 0.00f, 0.02f, 0.00f, dress, 2, BodyPart.Torso, BodyPart.Pelvis),
                new("clothing.vest_stars", "Uniform Vest", WearLayer.Outerwear, 0.13f, 0.05f, 0.00f, dress, 1, BodyPart.Torso),
                new("clothing.boots_cammy", "Combat Boots", WearLayer.Outerwear, 0.15f, 0.14f, 0.00f, dress, 0, BodyPart.LegL, BodyPart.LegR),
