...
namespace HexLive.Simulation.Content
{
    ...
    public static class WearSlotCatalog
    {
        ...
        private static readonly Dictionary<string, WearSlot[]> Slots = new()
        {
            ...
            ["clothing.croptop_idol_white"] = new[] { WearSlot.Chest },
            ...
            ["underwear.bra_lace_dream_lace_3_bra"] = new[] { WearSlot.Chest },
            ...
            ["underwear.briefs_lace_dream_lace_3_panty"] = new[] { WearSlot.Pelvis },
