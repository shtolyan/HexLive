...
namespace HexLive.Simulation.Content
{
    ...
    public static class WearSlotCatalog
    {
        ...
        private static readonly Dictionary<string, WearSlot[]> Slots = new()
        {
            ...
            ["clothing.shorts_vamp_blk_lea___lace"] = new[] { WearSlot.Pelvis },
            ...
            ["underwear.bikini_briefs_mat06"] = new[] { WearSlot.Belly, WearSlot.Pelvis },
            ...
            ["underwear.bikini_top_mat06"] = new[] { WearSlot.Chest },
