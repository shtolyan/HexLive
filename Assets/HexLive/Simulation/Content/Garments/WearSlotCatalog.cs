...
namespace HexLive.Simulation.Content
{
    ...
    public static class WearSlotCatalog
    {
        ...
        private static readonly Dictionary<string, WearSlot[]> Slots = new()
        {
            ...
            ["clothing.outfit_reiko"] = new[] { WearSlot.Chest, WearSlot.Belly, WearSlot.Pelvis, WearSlot.ThighR, WearSlot.ThighL, WearSlot.ShinR, WearSlot.ShinL, WearSlot.FootR, WearSlot.FootL },
