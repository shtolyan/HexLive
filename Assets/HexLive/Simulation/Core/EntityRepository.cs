...
public sealed class EntityRepository
{
    ...
    /// <summary>
    /// §28.15C v3: тела. Умершая НЕ исчезает — её <see cref="NPCState"/> целиком
    /// переезжает сюда: имя, тело с ранами, надетое и карманы. Тело лежит там,
    /// где упало, до конца игры; его можно обобрать (§28.15F) и разделать (§56).
    ///
    /// <para>
