...
// двери хижины (§29C.4A), только порогом служит кромка воды. Обратная сторона
// той же монеты — среда атаки как данные (MobStats.AttackMediums): акула бьёт
// ТОЛЬКО пловцов и дремлет против суши.
