...
namespace HexLive.Simulation.Runtime.Blueprints
{
    public static class BuiltInBuildingBlueprints
    {
        public static BuildingBlueprintDraft Hut1Hex()
        {
            ...
            PlaceNearest(draft, ContentIds.BedBasic, -0.974279f, 0f, 0);
            PlaceNearest(draft, ContentIds.BedBasic, 0.487139f, 0.84375f, 1);
            PlaceNearest(draft, "furniture.hearth", -0.3248f, 0.5625f, 0);
            PlaceNearest(draft, "furniture.wardrobe", -0.3247595f, -0.9375f, 4);
            draft.Normalize();
            return draft;
        }
