...
// §70: the SINGLE place hostility is defined. Nothing anywhere may spell
...
// using, and so the §70 kill-switch is a plain field access.
//
...
public static class FactionRelations
{
    ...
    {
        // Kill-switch: with §70 off the island is one big family again, so every
        // gate downstream collapses to its pre-§70 answer without a second code
        // path.
        return !Spec70.Enabled || a == b;
    }
