...
internal static class PerceptionMath
{
    ...
    // с листа персонажа — буквально 8 гексов, полный ролл — 0..10.
    // Объектное зрение §22.7 этой формулой НЕ управляется (§76.11).
    //
    // ⭐ ПОЛ В ОДИН ГЕКС. Бюджет §76.2 обязан положить чью-то ось на дно
    ...
    // остаётся тяжёлой обузой: 7 гексов обзора против 91 у среднего тела.
