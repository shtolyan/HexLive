...
public sealed partial class DecisionSystem : ISimulationSystem
{
    ...
    public void Run(WorldState world)
    {
        foreach (var npc in world.Entities.Npcs.Values)
        {
            ...
            // §70: a man stalking her counts exactly the same. Without this she
            ...
            if (!activelyHunted && Spec70.Enabled)
            {
            ...
            // §70: a bed per girl of HER OWN camp. Counting the whole island
            ...
            // §70 Raid: the outsider hunts the girls. He is an opportunist, so
            ...
            if (Spec70.Enabled &&
                ...
                world.Tick >= Spec70.RaidGraceDays * EnvironmentSystem.DayLengthTicks &&
                world.Tick >= npc.Mind.RaidCooldownUntilTick &&
                npc.Needs.Hunger <= Spec70.RaidSelfNeedCeiling &&
                npc.Needs.Thirst <= Spec70.RaidSelfNeedCeiling &&
                npc.Needs.Energy >= Spec70.RaidSelfEnergyFloor &&
            ...
            AddGoalScore(npc, world.Tick, GoalType.Raid,
                Spec70.RaidBaseScore + Spec70.RaidOpportunityGain * raidOpportunity, raidAvail);
