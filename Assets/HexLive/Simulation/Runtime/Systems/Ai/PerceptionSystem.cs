...
public sealed class PerceptionSystem : ISimulationSystem
{
    ...
    public void Run(WorldState world)
    {
        foreach (var npc in world.Entities.Npcs.Values)
        {
            ...
            npc.Perception.Hostiles.Clear(); // §70
            ...
            // §70: "company" means ALLIES. An outsider lurking on the island is
            // not someone she is less lonely for — and with the pre-§70 global
            ...
            foreach (var other in world.Entities.Npcs.Values)
            {
                ...
                // §70: which pile this one goes on. Hostiles skip the whole §53
