...
// §107: половина «дойти» у групповой охоты. Удары — в GroupHuntSystem, как у
...
public sealed partial class PlanningSystem
{
    private void BuildGroupHuntPlan(WorldState world, NPCState npc)
    {
        ...
        if (GroupHuntMath.PartyAlive(world, targetId) < Spec107.GroupHuntMinRemaining)
        {
        ...
        if (mine < rear - Spec107.GroupHuntSpreadTiles)
        {
            npc.Plan.Status = PlanStatus.Completed;
