...
public sealed class DreamSystem : ISimulationSystem
{
    ...
    public void Run(WorldState world)
    {
        ...
        {
            // §70: the COLONY's own hearth. Without the faction scope the
        ...
        // §70: TWO sets, and the distinction matters. Bed reclaim keys on
        ...
        WorldState world, DreamType dream, NPCState npc, HashSet<EntityId> bedOwners)
    {
        ...
        {
            case DreamType.Campfire:
                // §70: the outsider dreams of HIS hearth, not the girls' latch —
