...
namespace HexLive.UnityPresentation.Config
{
    ...
    public sealed class CharacterBalanceConfig : ScriptableObject
    {
        ...
        [Tooltip("До скольки должна зарасти ПРОБИТАЯ ГРУДЬ, чтобы встать. Против 0.02, в которые её запиннило падение: раньше выход спрашивал «выше пола?» и первый же тик регенерации поднимал её на ноги.")]
        [Range(0.02f, 0.6f)] public float torsoExitHealth = 0.15f;
