...
namespace HexLive.UnityPresentation.Config
{
    ...
    public sealed class CharacterBalanceConfig : ScriptableObject
    {
        ...
        [Tooltip("Линейное выцветание загара за медленный тик без загорающего УФ. 0.00016668 возвращает TanLevel 1→0 за четыре игровых дня (6000 slow-тиков) с учётом точности float.")]
        [Range(0f, 0.01f)] public float tanFadeRate = 0.00016668f;
