...
{
    /// <summary>
    /// §70 Враг-человек: чужак живёт на острове своим лагерем и охотится на
    ...
    /// Поле ассета = camelCase одноимённого статика Spec70.
    /// </summary>
    [CreateAssetMenu(menuName = "HexLive/Balance/Outsider", fileName = "OutsiderBalance")]
    [MirrorTarget(typeof(Spec70))]
    public sealed class OutsiderBalanceConfig : ScriptableObject
    {
        [Header("Общее (§70)")]
        [Tooltip("Выключить — фракций как будто нет: все снова свои, поведение возвращается к до-§70 байт-в-байт.")]
