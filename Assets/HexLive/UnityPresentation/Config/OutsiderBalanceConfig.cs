...
namespace HexLive.UnityPresentation.Config
{
    ...
    public sealed class OutsiderBalanceConfig : ScriptableObject
    {
        ...
        [Tooltip("Каждые N календарных дней лагерь дикарей получает одного нового бойца (3 = дни 3, 6, 9…). 0 отключает новые волны, но не стартового чужака.")]
        [Range(0, 60)] public int raidWaveIntervalDays = 3;
