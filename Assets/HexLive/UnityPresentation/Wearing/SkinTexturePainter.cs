            ...
            bool isGauze = false, bool isPlaster = false)
        {
            ...
            if (_map != null)
            {
                ...
                if (isBandage && !isPlaster)
                {
                    ...
                    // #246/#256: эти шесть зон ИМЕЮТ обязательную authored-
                    // обмотку. Она поставляется в bootstrap Player и доступна
                    // синхронно для рук, ног и корпуса; отсутствующий файл не
                    // маскируется устаревшей круглой нашлёпкой.
