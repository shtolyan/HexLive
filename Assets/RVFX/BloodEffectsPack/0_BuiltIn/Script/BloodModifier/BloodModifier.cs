...
namespace BloodEffectsPack
{
    public class BloodModifier : MonoBehaviour
    {
        ...
        public BloodModifierSettings settings = new BloodModifierSettings();
        public BloodPreset[] decalPresets;
        public BloodPreset[] splashPresets;

        private readonly Dictionary<Projector, Material> originalProjectorMaterials = new Dictionary<Projector, Material>();
        private readonly Dictionary<Projector, Material> runtimeProjectorMaterials = new Dictionary<Projector, Material>();
        ...
        public void OverrideSettings(BloodModifierSettings overrideSettings)
        {
        ...
        public void ApplyToSharedMaterialsInEditor()
        {
            ...
            BloodModifierUtility.ApplySettingsToGameObjectShared(gameObject, settings);
        ...
        public void ApplyToMaterialInstancesInRuntime()
        {
            ...
            for (int i = 0; i < particleSystems.Length; i++)
            {
                ...
                BloodModifierUtility.ApplySettingsToMaterial(instanceMat, settings);
            }
            ...
            for (int i = 0; i < projectors.Length; i++)
            {
                ...
                BloodModifierUtility.ApplySettingsToMaterial(runtimeMat, settings);
            }
        }
        ...
        private Material GetOrCreateRuntimeProjectorMaterial(Projector projector)
        {
            if (projector == null)
                return null;
