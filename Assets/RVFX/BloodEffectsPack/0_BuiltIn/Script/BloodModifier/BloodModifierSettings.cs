...
{
    [Serializable]
    public class BloodModifierSettings
    {
        public BloodModifier.EffectType effectType = BloodModifier.EffectType.Splash;
        ...
        public void CopyFrom(BloodModifierSettings other)
        {
            if (other == null)
                return;
        ...
        public void CopyFromPreset(BloodPreset preset, BloodModifier.EffectType effectTypeValue)
        {
            if (preset == null)
                return;
