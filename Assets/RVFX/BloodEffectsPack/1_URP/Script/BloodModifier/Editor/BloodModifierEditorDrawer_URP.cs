...
{
    public static class BloodModifierEditorDrawer_URP
    {
        public static void DrawSettings(SerializedProperty settingsProp)
        {
            ...
            if (effectTypeProp != null &&
                effectTypeProp.enumValueIndex == (int)BloodModifier_URP.EffectType.Splash &&
        ...
        public static void DrawPresetButtons(
            BloodModifierSettings_URP settings,
            ...
            Action<BloodPreset> onPresetClicked)
        {
            ...
            BloodPreset[] targetPresets =
                settings.effectType == BloodModifier_URP.EffectType.Decal
                ? decalPresets
                : splashPresets;
