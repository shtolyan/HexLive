...
{
    [CustomEditor(typeof(TrailProjectorSpawnerSystem_URP))]
    public class TrailProjectorSpawnerSystemEditor_URP : Editor
    {
        ...
        private void ClearCachedProperties()
        {
            ...
            spawnDistanceMinProp = null;
            spawnDistanceMaxProp = null;
            durationProp = null;
        ...
        public override void OnInspectorGUI()
        {
            ...
            TrailProjectorSpawnerSystem_URP spawner = target as TrailProjectorSpawnerSystem_URP;
            if (spawner == null)
                return;
        ...
        {
            DrawPropertySafe(spawnDistanceMinProp);
            DrawPropertySafe(spawnDistanceMaxProp);
            DrawPropertySafe(durationProp);
        }
        ...
        private void DrawColorTab(TrailProjectorSpawnerSystem_URP spawner)
        {
            if (spawner == null)
                return;
            ...
            BloodModifierEditorDrawer_URP.DrawPresetButtons(
                ...
                preset =>
                {
                    ...
                    Undo.RecordObject(target, "Load Trail Blood Preset Values URP");
        ...
        private void DrawSpawnerApplySection(TrailProjectorSpawnerSystem_URP spawner)
        {
