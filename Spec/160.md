...
Захват выполняется FMOD Core: повторное нажатие или 0.8 с тишины завершает
запись, предел 30 секунд, минимум 250 мс; слишком тихий сигнал отбрасывается.
`VoiceCaptureDuck` приглушает игру примерно на 18 dB и снимается на каждом пути
окончания/ошибки/смены выбора/сцены/`OnDisable`.
...
нет другого голосового хода. Блокировки: loading/replay, отсутствующий агент,
STT, микрофон или уже идущий ход.
