...
- **AI-generated tool models** (axe/knife/pickaxe/lighter/hammer/machete +
  ...
  the shared `ObjectFit` to `0.036 × HexRadius` (**0.054 world units**) in
  both world and hand. The compact target is the bug #341 correction: the
  previous `0.18 × HexRadius` bottle read about five times too large in both
  contexts. Unlike dropped weapons it remains upright: ground yaw preserves the native wrapper's
