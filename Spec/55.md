...
Вид воды: пустая бутылка становится **Raw**; непустая сохраняет свой вид
(сознательное правило — простота важнее гидрологии смеси). Приёмник —
...
двумя ёмкостями. Поле прописано в `WorldSnapshotCodec`.
