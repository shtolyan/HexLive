...
public sealed class SystemRegistryGateTests
{
    ...
    private static readonly string[] ExpectedOrder =
    {
        ...
        // §136: дневник закрывает игровой час, поэтому стоит после всех — в том
        // числе после наблюдателей. Сдвинуть его выше значит терять события,
        // случившиеся в конце часа.
        "JournalSystem",
    };
