...
| [§150](Spec/150.md) | Мини-карта, дальний обзор настоящего мира и личная видимость (iteration 150) |
| [§151](Spec/151.md) | Лутаемые станции и буфер топлива (iteration 151) |
| [§152](Spec/152.md) | Атомарный удалённый контент (iteration 152) |
| [§153](Spec/153.md) | Подарки: любой предмет через меню персонажа (iteration 153) |
| [§154](Spec/154.md) | Единый каталог контента и веб-админка (iteration 154) |
| [§155](Spec/155.md) | Резидентность контента по восприятию (iteration 155) |
| [§156](Spec/156.md) | Спящие чанки (iteration 156) |
| [§157](Spec/157.md) | Острова (iteration 157) |
| [§158](Spec/158.md) | Мир без полных обходов: журнал топологии и локальные поиски (iteration 158) |
| [§159](Spec/159.md) | LLM-героиня Маша и голос игрока (iteration 159) |
| [§160](Spec/160.md) | MCP-агент: присутствие, голос и интерфейс (iteration 160) |
| [§161](Spec/161.md) | Голосовой режим администратора |
| [§162](Spec/162.md) | Лобби создания мира на удалённом сервере |
| [§163](Spec/163.md) | Agent Studio — локальные MCP-агенты, интеграции и отношения (iteration 163) |
| [§164](Spec/164.md) | Переносимые промпты агента и язык собеседника (iteration 164) |
| [§165](Spec/165.md) | Локальный архив и поиск памяти Agent Studio (iteration 165) |
| [§166](Spec/166.md) | Единый ключ закрытого теста и выбор официального сервера (iteration 166) |
| [§167](Spec/167.md) | Указания и лидерство — просьба, согласие и власть, которую слушают (iteration 167) |
