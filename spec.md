...
### §119.4 Капсула прогресса над предметом

Над каждым незавершённым выходным объектом находится camera-facing world-space
капсула: тёмный объёмный корпус, зелёное заполнение, светлый блик и мягкая
тень. Она привязана к результату, а не к голове работника. Во время работы
капсула яркая и слегка пульсирует; между подходами остаётся видимой, но
приглушённой; при 100% исчезает. На верстаке якорь находится над центральным
результатом, на земле — над моделью выходного предмета.
