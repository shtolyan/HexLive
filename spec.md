...
**Отгружено ВЫКЛЮЧЕННЫМ** (`Spec72.Enabled` и `SpawnOutsider` = `false`), пока
не набрана статистика на нескольких сидах: одного прогона мало, чтобы судить о
балансе, а по нему чужак скорее слаб — вышел один раз и был забит.
