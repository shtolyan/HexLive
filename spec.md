...
**104.6 Что осталось копией и почему.** Половина melee-урона (защитницы против
собак в `MobSystem`, весь §56 в `PredationSystem`) по-прежнему идёт по легаси
фазовой модели и видовых сигналов не ставит: их удары невидимы. Миграция на
общий таймлайн меняет и каденцию, и летальность, а собачий баланс на грани —
поэтому она отдельной итерацией, под флагом и с A/B-соаками.
