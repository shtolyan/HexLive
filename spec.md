...
## §118 Ручное управление персонажем (iteration 118)
...
### §118.2 Правило Кенши: ответ на удары
...
- **Нулевой дифф.** При `Spec118.ManualControlEnabled` и НУЛЕ ручных персонажей
  мир обязан считаться байт в байт как до §118 — проверяется `golden_trace.sh`
